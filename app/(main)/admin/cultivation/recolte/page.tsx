...
const Crud = () => {
    ...
    const [listeRecolte, setListeRecolte] = useState(null);
    ...
    useEffect(() => {
        ...
        ProductService.getListeRecolte().then((data) => setListeRecolte(data as any));
        // fetchList_Type_Vin();
    }, []);
    ...
    const id_recolte_template = (rowData: Demo.Recolte) => {
        return (
            <>
                <span className="p-column-title">id_recolte</span>
                {rowData.id_recolte}
            </>
        );
    };
    ...
    const Nom_vignoble_template = (rowData: Demo.Recolte) => {
        return (
            <>
                <span className="p-column-title">Nom du vignoble</span>
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Liste des recoltes</h5>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="id_recolte" header="code" sortable body={id_recolte_template} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="date_recolte" header="Recolté le" sortable body={date_recolte_template} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="Nom_vignoble" header="Depuis le vignoble" sortable headerStyle={{ minWidth: '15rem' }}></Column>
